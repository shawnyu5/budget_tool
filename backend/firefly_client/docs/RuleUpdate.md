...
**trigger** | Option<[**models::RuleTriggerType**](RuleTriggerType.md)> |  | [optional]
...
**triggers** | Option<[**Vec<models::RuleTriggerUpdate>**](RuleTriggerUpdate.md)> |  | [optional]
**actions** | Option<[**Vec<models::RuleActionUpdate>**](RuleActionUpdate.md)> |  | [optional]

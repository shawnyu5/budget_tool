...
**object_has_currency_setting** | Option<**bool**> | Indicates whether the transaction has a currency setting. For transactions this is always true. | [optional][readonly]
**currency_id** | Option<**String**> | Currency ID for the currency of this transaction. | [optional]
**currency_code** | Option<**String**> | Currency code for the currency of this transaction. | [optional]
**currency_symbol** | Option<**String**> | Currency symbol for the currency of this transaction. | [optional][readonly]
**currency_name** | Option<**String**> | Currency name for the currency of this transaction. | [optional]
**currency_decimal_places** | Option<**i32**> | Number of decimals used in this currency. | [optional]
**foreign_currency_id** | Option<**String**> | Currency ID of the foreign currency, if this transaction has a foreign amount. | [optional]
**foreign_currency_code** | Option<**String**> | Currency code of the foreign currency. Default is NULL. | [optional]
**foreign_currency_symbol** | Option<**String**> |  | [optional][readonly]
**foreign_currency_decimal_places** | Option<**i32**> | Number of decimals in the foreign currency. | [optional][readonly]
**primary_currency_id** | Option<**String**> | Returns the primary currency ID of the administration. This currency is used as the currency for all `pc_*` amount and balance fields of this account. | [optional][readonly]
**primary_currency_code** | Option<**String**> | Returns the primary currency code of the administration. This currency is used as the currency for all `pc_*` amount and balance fields of this account. | [optional]
**primary_currency_symbol** | Option<**String**> | See the other `primary_*` fields. | [optional][readonly]
**primary_currency_decimal_places** | Option<**i32**> | See the other `primary_*` fields. | [optional][readonly]
**amount** | **String** | Amount of the transaction. | 
**pc_amount** | Option<**String**> | Amount of the transaction in the primary currency of this administration. The `primary_currency_*` fields reflect the currency used. This field is NULL if the user does have 'convert to primary' set to true in their settings. | [optional]
**foreign_amount** | Option<**String**> | The amount in the set foreign currency. May be NULL if the transaction does not have a foreign amount. | [optional]
**pc_foreign_amount** | Option<**String**> | Foreign amount of the transaction in the primary currency of this administration. The `primary_currency_*` fields reflect the currency used. This field is NULL if the user does have 'convert to primary' set to true in their settings. | [optional]
**source_balance_after** | Option<**String**> | The balance of the source account. This is the balance in the account's currency which may be different from this transaction, and is not provided in this model. | [optional]
**pc_source_balance_after** | Option<**String**> | The balance of the source account in the primary currency of this administration. The `primary_currency_*` fields reflect the currency used. This field is NULL if the user does have 'convert to primary' set to true in their settings. | [optional]
**destination_balance_after** | Option<**String**> | The balance of the destination account. This is the balance in the account's currency which may be different from this transaction, and is not provided in this model. | [optional]
**pc_destination_balance_after** | Option<**String**> | The balance of the destination account in the primary currency of this administration. The `primary_currency_*` fields reflect the currency used. This field is NULL if the user does have 'convert to primary' set to true in their settings. | [optional]
...
**budget_name** | Option<**String**> | The name of the budget used. | [optional][readonly]
...
**bill_id** | Option<**String**> | The associated subscription ID for this transaction. `bill` refers to the OLD name for subscriptions and this field will be removed. | [optional]
**bill_name** | Option<**String**> | The associated subscription name for this transaction. `bill` refers to the OLD name for subscriptions and this field will be removed. | [optional]
**subscription_id** | Option<**String**> | The associated subscription ID for this transaction. | [optional]
**subscription_name** | Option<**String**> | The associated subscription name for this transaction. | [optional]

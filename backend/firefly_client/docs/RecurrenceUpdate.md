...
**repeat_until** | Option<[**String**](String.md)> | Date until when the recurring transaction can fire. After that date, it's basically inactive. Use either this field or repetitions. | [optional]
...
**repetitions** | Option<[**Vec<models::RecurrenceRepetitionUpdate>**](RecurrenceRepetitionUpdate.md)> |  | [optional]
**transactions** | Option<[**Vec<models::RecurrenceTransactionUpdate>**](RecurrenceTransactionUpdate.md)> |  | [optional]

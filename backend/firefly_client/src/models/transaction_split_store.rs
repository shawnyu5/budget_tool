...
pub struct TransactionSplitStore {
    ...
    pub piggy_bank_id: Option<Option<i32>>,
...
impl TransactionSplitStore {
    pub fn new(r#type: models::TransactionTypeProperty, date: String, amount: String, description: String) -> TransactionSplitStore {

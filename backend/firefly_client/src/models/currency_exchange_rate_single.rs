...
pub struct CurrencyExchangeRateSingle {
    #[serde(rename = "data")]
    pub data: Box<models::CurrencyExchangeRateRead>,
}

impl CurrencyExchangeRateSingle {
    pub fn new(data: models::CurrencyExchangeRateRead) -> CurrencyExchangeRateSingle {

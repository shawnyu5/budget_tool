...
pub struct UserGroupRead {
    ...
    pub attributes: Box<models::UserGroupReadAttributes>,
    #[serde(rename = "links")]
    pub links: Box<models::ObjectLink>,
}

impl UserGroupRead {
    pub fn new(r#type: String, id: String, attributes: models::UserGroupReadAttributes, links: models::ObjectLink) -> UserGroupRead {
        UserGroupRead {
            r#type,
            id,

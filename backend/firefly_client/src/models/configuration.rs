...
pub struct Configuration {
    #[serde(rename = "title")]
    pub title: models::ConfigValueFilter,
    #[serde(rename = "value")]
    pub value: Box<models::PolymorphicProperty>,
...
impl Configuration {
    pub fn new(title: models::ConfigValueFilter, value: models::PolymorphicProperty, editable: bool) -> Configuration {
        Configuration {
            title,
            value: Box::new(value),
            editable,

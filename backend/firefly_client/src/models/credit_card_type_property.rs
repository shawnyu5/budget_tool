...
pub enum CreditCardTypeProperty {
    #[serde(rename = "monthlyFull")]
    MonthlyFull,

}

impl std::fmt::Display for CreditCardTypeProperty {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::MonthlyFull => write!(f, "monthlyFull"),
        }
    }
}

impl Default for CreditCardTypeProperty {
    fn default() -> CreditCardTypeProperty {
        Self::MonthlyFull
    }
}

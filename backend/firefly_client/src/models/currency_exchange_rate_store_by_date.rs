...
pub struct CurrencyExchangeRateStoreByDate {
    /// The 'from'-currency
    #[serde(rename = "from")]
    pub from: String,
...
impl CurrencyExchangeRateStoreByDate {
    pub fn new(from: String, rates: std::collections::HashMap<String, String>) -> CurrencyExchangeRateStoreByDate {

...
pub struct RecurrenceRead {
    ...
    pub attributes: Box<models::RecurrenceProperties>,
    #[serde(rename = "links")]
    pub links: Box<models::ObjectLink>,
}

impl RecurrenceRead {
    pub fn new(r#type: String, id: String, attributes: models::RecurrenceProperties, links: models::ObjectLink) -> RecurrenceRead {
        RecurrenceRead {
            r#type,
            id,

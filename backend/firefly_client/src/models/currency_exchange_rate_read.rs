...
pub struct CurrencyExchangeRateRead {
    /// Immutable value
    ...
    pub attributes: Option<Box<models::CurrencyExchangeProperties>>,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<Box<models::ObjectLink>>,
}

impl CurrencyExchangeRateRead {
    pub fn new() -> CurrencyExchangeRateRead {

...
pub struct AttachmentRead {
    ...
    pub attributes: Box<models::AttachmentProperties>,
    #[serde(rename = "links")]
    pub links: Box<models::ObjectLink>,
}

impl AttachmentRead {
    pub fn new(r#type: String, id: String, attributes: models::AttachmentProperties, links: models::ObjectLink) -> AttachmentRead {
        AttachmentRead {
            r#type,
            id,

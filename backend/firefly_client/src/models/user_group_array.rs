...
pub struct UserGroupArray {
    #[serde(rename = "data")]
    pub data: Vec<models::UserGroupRead>,
    #[serde(rename = "meta")]
...
impl UserGroupArray {
    pub fn new(data: Vec<models::UserGroupRead>, meta: models::Meta, links: models::PageLink) -> UserGroupArray {
        UserGroupArray {
            data,
            meta: Box::new(meta),
            links: Box::new(links),

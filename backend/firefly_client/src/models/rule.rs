...
pub struct Rule {
    ...
    pub triggers: Vec<models::RuleTrigger>,
    #[serde(rename = "actions")]
    pub actions: Vec<models::RuleAction>,
}

impl Rule {
    pub fn new(title: String, rule_group_id: String, trigger: models::RuleTriggerType, triggers: Vec<models::RuleTrigger>, actions: Vec<models::RuleAction>) -> Rule {
        Rule {
            created_at: None,
            updated_at: None,
            title,

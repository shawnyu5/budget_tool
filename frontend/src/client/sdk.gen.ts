...
export const graphqlHandler = <ThrowOnError extends boolean = false>(options?: Options<GraphqlHandlerData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<GraphqlHandlerResponses, unknown, ThrowOnError>({
        url: '/graphql',
        ...options
    });
};

...
import { handleGraphQLClientError, handleGraphQLErrorObject, NewGraphQLSDK } from "~/graphql";
import log from "~/logger";
import { getMonthlyBudget, SpendingItem, updateMonthlyBudget } from "~/server";
   ...
   const onSubmit = async (
      ...
      try {
         ...
         if (res.addSpendingItemByMonth.__typename == "GraphQLErrorObject") {
            handleGraphQLErrorObject(res.addSpendingItemByMonth, navigate)
         }
      } catch (e) {
